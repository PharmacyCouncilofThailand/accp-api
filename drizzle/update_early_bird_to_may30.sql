-- =============================================================================
-- Manual data update: Extend Early Bird ticket end date to 30 May 2026
-- =============================================================================
...
--
-- New Early Bird sale_end_date:      2026-05-30 17:00:00 UTC
--   (= 2026-05-31 00:00:00 Bangkok / GMT+7, i.e. valid through May 30 BKK)
--
...
--   psql $DATABASE_URL -f drizzle/update_early_bird_to_may30.sql
-- =============================================================================

BEGIN;

-- 1) Push Early Bird sale_end_date to end of 30 May 2026 (Bangkok time)
UPDATE ticket_types
SET sale_end_date = '2026-05-30 17:00:00'::timestamp
...
UPDATE ticket_types
SET sale_start_date = '2026-05-30 17:00:00'::timestamp
...
WHERE priority = 'early_bird'
  AND is_active = false
  AND sale_end_date = '2026-05-30 17:00:00'::timestamp;
