...
export const abstracts = pgTable("abstracts", {
  ...
  presentationRoom: varchar("presentation_room", { length: 255 }),
  presentationStartTime: varchar("presentation_start_time", { length: 10 }),
  presentationEndTime: varchar("presentation_end_time", { length: 10 }),
  posterBoardNumber: varchar("poster_board_number", { length: 10 }),
  posterInstallationStart: varchar("poster_installation_start", { length: 10 }),
  posterInstallationEnd: varchar("poster_installation_end", { length: 10 }),
  posterRemovalStart: varchar("poster_removal_start", { length: 10 }),
  posterRemovalEnd: varchar("poster_removal_end", { length: 10 }),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
